...
nvidia-settings -a [gpu:1]/GPUGraphicsClockOffset[3]=185
nvidia-settings -a [gpu:2]/GPUGraphicsClockOffset[3]=185
nvidia-settings -a [gpu:3]/GPUGraphicsClockOffset[3]=185
#POS card keeps overheating no overclock
nvidia-settings -a [gpu:4]/GPUGraphicsClockOffset[3]=125
nvidia-settings -a [gpu:5]/GPUGraphicsClockOffset[3]=185 
nvidia-settings -a [gpu:6]/GPUGraphicsClockOffset[3]=185
nvidia-settings -a [gpu:7]/GPUGraphicsClockOffset[3]=185
#Crashed once
nvidia-settings -a [gpu:8]/GPUGraphicsClockOffset[3]=185
nvidia-settings -a [gpu:9]/GPUGraphicsClockOffset[3]=185
nvidia-settings -a [gpu:10]/GPUGraphicsClockOffset[3]=185
nvidia-settings -a [gpu:11]/GPUGraphicsClockOffset[3]=185
